  ...
  return (
      <div>
          ...
          <div className="text-center  space-x-2 space-y-3">
              <h1
                  data-aos="fade-right"
                  className='text-[#cd114e] text-4xl font-medium'>Services</h1>
                      ...
                      <div className="flex flex-wrap -mx-6 lg:-mx-8">
                          <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-8 mb-20 lg:mb-0">
                              ...
                              <p
                                  ...
                                  className="text-lg ">The brown me quam, sagittis porttitor lorem vel, commodo fringilla nisl.</p>
                          </div>
                          <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-8 mb-20 lg:mb-0">
                              ...
                              <p
                                  data-aos="fade-down"
                                  className="text-lg ">It’s over, maecenas tincidunt malesuada dolor sit amet malesuada.</p>
                          </div>
                          <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-8 mb-10 lg:mb-0">
                              ...
                              <p
                                  data-aos="fade-up"
                                  className="text-lg ">The time, this accumsan augue, posuere posuere elit lorem.</p>
                          </div>
                          <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-8">
                              ...
                              <p
                                  data-aos="fade-left"
                                  className="text-lg ">Again and again vehicula libero at nibh volutpat lacinia non sed you see.</p>
                          </div>
                      </div>
                  </div>
              </div>
